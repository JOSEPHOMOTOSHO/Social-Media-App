...
import { removePost, like, unlike } from "./api-post";
...
export default function Post(props) {
  ...
  //     ? `/api/users/photo/${prop.viewedUser._id}?${new Date().getTime()}`
  //     : "/api/users/defaultphoto";

  const clickLike = () => {
    let apiCall = values.like ? unlike : like;
  ...
  return (
    <Card>
      <CardHeader
        ...
        title={
          <Link to={"/users/" + props.post.postedBy._id}>
